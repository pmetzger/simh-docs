...
<table> <colgroup> <col style="width: 26%" /> <col style="width: 73%" />
</colgroup> <tbody> <tr> <td>BOOT CDR</td> <td><p>Loads the first card
into memory location 0.</p> <p>Transfers to location 4.</p></td> </tr>
</tbody> </table>
