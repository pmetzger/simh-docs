...
<span class="mark">This is a work in progress.</span>
...
1\. Introduction to the IBM 1130 [1](#introduction-to-the-ibm-1130)

2\. The Emulated 1130 [3](#the-emulated-1130)

3\. Files Included with the Emulator [4](#files-included-with-the-emulator)

3.1. SIMH Users [4](#simh-users)

3.2. Standalone Users [4](#standalone-users)

3.3. What's in the ZIP files [4](#whats-in-the-zip-files)

4\. Installing the Emulator [8](#installing-the-emulator)

4.1. Installing on Windows [8](#installing-on-windows)

4.2. Installing and Building for Other Operating Systems [8](#installing-and-building-for-other-operating-systems)

5\. Using the Emulator [10](#using-the-emulator)

5.1. Emulator Commands [10](#emulator-commands)

5.2. DO Scripts [12](#do-scripts)

5.3. Drag and Drop [12](#drag-and-drop)

6\. Emulator Commands for Peripheral Control [13](#emulator-commands-for-peripheral-control)

6.1. The CPU [13](#the-cpu)

6.2. Console Printer and Telnet Support [14](#console-printer-and-telnet-support)

6.3. Line Printer [15](#line-printer)

6.4. Disk Drives [16](#disk-drives)

6.5. Card Reader [17](#card-reader)

6.6. Card Punch [19](#card-punch)

6.7. 1627 Plotter [19](#plotter)

6.8. Paper Tape Reader/Punch [21](#paper-tape-readerpunch)

6.9. 2250 Graphics Display [22](#graphics-display)

6.10. Synchronous Communications Adapter [22](#synchronous-communications-adapter)

6.11. 2741 Terminal Support [22](#terminal-support)

7\. The Emulator Display [23](#the-emulator-display)

8\. IBM 1130 Disk Monitor System (DMS) Release 2 Version 12 [26](#ibm-1130-disk-monitor-system-dms-release-2-version-12)

8.1. Booting the Emulated IBM 1130 [26](#booting-the-emulated-ibm-1130)

8.2. Running DMS Entirely from the GUI [27](#running-dms-entirely-from-the-gui)

8.3. Cold Start Program Wait Codes [27](#cold-start-program-wait-codes)

8.4. DMS Disk Basics [27](#dms-disk-basics)

8.5. DMS Job Decks [28](#dms-job-decks)

8.6. Error Wait Codes [30](#error-wait-codes)

9\. Monitor Control Records [32](#monitor-control-records)

9.1. Supervisor Control Records [34](#supervisor-control-records)

10\. Disk Utility Program (DUP) [35](#disk-utility-program-dup)

10.1. DUP Control Records [36](#dup-control-records)

10.2. Temporary Mode Restrictions [39](#temporary-mode-restrictions)

11\. IBM 1130 Fortran [40](#ibm-1130-fortran)

11.1. Using Functions and Subroutines [40](#using-functions-and-subroutines)

11.2. Fortran Control Records [41](#fortran-control-records)

11.3. Fortran Declaration Statements [42](#fortran-declaration-statements)

11.4. Fortran Program Statements [43](#fortran-program-statements)

11.5. Fortran Subroutine Library [44](#fortran-subroutine-library)

11.6. Plotter Library [46](#plotter-library)

11.7. Fortran Compiler Error Codes [46](#fortran-compiler-error-codes)

11.8. Fortran Program I/O Error Wait Codes [50](#fortran-program-io-error-wait-codes)

12\. Macro Assembler [51](#macro-assembler)

12.1. Assembler Control Records [51](#assembler-control-records)

12.2. Assembler Statement Format [52](#assembler-statement-format)

12.3. Assembler Constants and Expressions [52](#assembler-constants-and-expressions)

12.4. Assembler Directives and Pseudo-Ops [53](#assembler-directives-and-pseudo-ops)

12.5. Instruction Opcodes [54](#instruction-opcodes)

12.6. Macro Assembler Error Flags [55](#macro-assembler-error-flags)

13\. Loading a DMS Disk Image [57](#loading-a-dms-disk-image)

13.1. Required Files [57](#required-files)

13.2. Required Utilities [57](#required-utilities)

13.3. Assembling DMS and Components [57](#assembling-dms-and-components)

13.4. Building DMS for a 1132 Printer [57](#building-dms-for-a-1132-printer)

13.5. Building DMS for a 1403 Printer [57](#building-dms-for-a-1403-printer)

13.6. Building DMS for Alternate Memory Configurations [57](#building-dms-for-alternate-memory-configurations)

14\. Data Formats [58](#data-formats)

15\. Character Codes [60](#character-codes)

16\. Known Problems/Limitations [63](#known-problemslimitations)

16.1. Simulator issues [63](#simulator-issues)

16.2. DMS issues [63](#dms-issues)
...
|  |  |  |
|----|----|----|
| <img src="mdbook/src/ibm1130_assets/image1.jpeg" style="width:1.98264in;height:1.64306in" /> | <img src="mdbook/src/ibm1130_assets/image2.jpeg" style="width:1.98264in;height:2.07431in" /> | <img src="mdbook/src/ibm1130_assets/image3.jpeg" style="width:1.98264in;height:1.9in" /> |
...
<img src="mdbook/src/ibm1130_assets/image4.jpeg" style="width:2in;height:1.93472in" />
...
The IBM1130 emulator is based on Bob Supnik's SIMH package as part of the Computer History Simulation Project (see [http://simh.trailing-edge.com](http://simh.trailing-edge.com/)). The simulator and ancillary programs such as the cross-assembler are written in ANSI-C, and may be compiled on Unix, Linux, VMS and Win32 platforms. The program is a command line, text based program. A graphical user interface option is available on Win32.
...
| sim_sock.c | simh network IO routines <span class="mark"><sup>Error: Reference source not found</sup></span> |
...
To use the emulator on Windows, download ibm1130software.zip from [www.ibm1130.org](http://www.ibm1130.org/ibm1130software.zip) or [www.quarterbyte.com](http://www.quarterbyte.com/ibm1130software.zip) and unzip it into a working directory, say \ibm1130. This directory will contain the Windows executables and the sample job files.

If you want to work with the emulator source code, follow the instructions for working with other operating systems as described in the next section. If you have a Microsoft compiler you can use the .mak files provided with the source code. If you use another compiler, you can use the standard makefiles.
...
> <u>go</u> Pressing Program Start
>
> <u>deposit ces *xxxx*</u> Setting the Console Entry Switches to hex value *xxxx*
>
> <u>deposit iar *xxxx*</u> Pressing Load IAR with console switches set to *xxxx*
>
> <u>reset</u> Pressing Check Reset
>
> <u>boot dsk</u> Pressing Check Reset, Program Load, Program Start with the DMS R2V12 cold start card in the card reader
>
> <u>boot cr</u> Pressing Check Reset, Program Load, Program Start to boot from the card reader. (The virtual card reader must be attached to a binary file containing the image of a cold-start card)
...
Any arguments entered after the script filename are available to the script as tokens %1, %2, etc. These substitution tokens may also appear in deck files (see "Indirect (deck) files" on page [18](#indirect-deck-files)).
...
<thead>
<tr>
<th><strong>Register Name</strong></th>
...
<td>Instruction Address Register (program counter)</td>
</tr>
<tr>
<td><blockquote>
<p>ACC</p>
...
<td>Console Entry Switches (Switch 0 = 8000, Switch 1 = 4000, ... Switch 15 = 0001).</td>
</tr>
</tbody>
</table>
...
Attaching a file to the CPU device creates a log showing CPU register values before each instruction and lists each instruction executed. This can create quite large output files, so it must be used arefully.
...
> <img src="mdbook/src/ibm1130_assets/image5.png" style="width:5.45069in;height:3.64306in" />  
...
4.  <img src="mdbook/src/ibm1130_assets/image6.png" style="width:1.19792in;height:1.20833in" />Click the "Program Start" button. Wait until the lights stop flashing and the accumulator displays 1000 hex. The cards on the card reader icon will move to the stacker.
...
Displays the location equivalence table (user area directory) of the specified cartridge, or if <u>cart</u> is omitted, all cartridges. The listing is limited to a specific file if a filename <u>fname</u> is specified, otherwise all files are listed. If a fixed area is listed, the FLET is listed as well.
...
Displays the fixed location equivalence table (fixed area directory) of the specified cartridge, or if <u>cart</u> is omitted, all cartridges. The listing is limited to a specific file if a filename <u>fname</u> is specified, otherwise all files are listed.
...
The Fortran library is documented in the IBM publication *IBM 1130 Subroutine Library*, File no. 1130-30, Form C26-5929-2, which you can obtain as a PDF file from <u>www.ibm1130.org</u>. The library routines are summarized in this section.
...
Extended precision floating point numbers are stored in three words with no address restrictions. The 32-bit mantissa is stored as a two's complement signed value with an implied binary point between bits 0 and 1of the second word. The characteristic (binary exponent) is offset by 128. Numbers are stored in normalized form so for positive numbers bit 1 is always 1 and for negative numbers bit 1 is always 0. Zero is represented as all 48 bits set to 0
...
[^2]: These utilities are not terribly important. They were written mainly as debugging aids during development of the emulator and while learning how to build DMS.
