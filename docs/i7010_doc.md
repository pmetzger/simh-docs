...
<table> <colgroup> <col style="width: 33%" /> <col style="width: 66%" />
</colgroup> <tbody> <tr> <td>BOOT CDR<em>n</em></td> <td><p>Reads first
card into address 1.</p> <p>Starts execution at location 1.</p></td>
</tr> </tbody> </table>
